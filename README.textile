...
of grammars. 
For now Parsley use the same technique as described in this paper: 
...
no node will be generated in the parse-tree for this rules, its child nodes are
